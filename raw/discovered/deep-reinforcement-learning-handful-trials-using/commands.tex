...
\newcommand{\prob}{{\text{Pr}}} % (p was conflicting with p particle index - RM.) % probability density function
...
\newcommand{\approximator}[1]{\widetilde{#1}}  % An approximation

\newcommand{\degrees}[0]{\circ}
\newcommand{\horizon}[0]{T}
...
\newcommand{\MDPTransition}[0]{f}
\newcommand{\MDPdimState}[0]{{d_s}}
\newcommand{\MDPdimAction}[0]{{d_a}}

\newcommand{\dynamicsModel}[0]{\approximator{\MDPTransition}}
\newcommand{\traj}[0]{\tau}
...
\newcommand{\rowan}[1]{\todo[inline]{TODO[Rowan]: #1}}
\newcommand{\kurtland}[1]{\todo[inline]{TODO[Kurtland]: #1}}
\newcommand{\roberto}[1]{\todo[inline]{TODO[Roberto]: #1}}
\newcommand{\bootstrap}[0]{b}  % e
\newcommand{\Bootstrap}[0]{B}  % E
