...
concepts:
  - slug: amortized-context-encoder-adaptation
  ...
  - slug: momentum-preserving-pbd-inextensibility
    ...
    maturity: emerging
  - slug: motion-manifold-primitives
  ...
  - slug: neural-residual-on-physics-model
    ...
    maturity: active
  - slug: online-meta-learned-dynamics-adaptation
...
topics:
  - slug: compact-action-parameterization
  ...
  - slug: dynamic-deformable-object-simulation
  ...
  - slug: dynamic-dlo-tip-targeting
  ...
  - slug: dynamic-throwing-and-hitting
  ...
  - slug: model-based-planning-for-manipulation
  ...
  - slug: sim-to-real-and-rapid-adaptation
...
people:
  ...
  - slug: jitendra-malik
    kind: researcher
    affiliation: "UC Berkeley; Facebook AI Research (FAIR)"
  - slug: jonathan-wang
  ...
  - slug: kurtland-chua
    kind: researcher
    affiliation: "Princeton University (PhD); UC Berkeley (at time of PETS)"
  - slug: masoud-moghani
  ...
  - slug: vincent-lim
    tags: [DLO, robot-learning, sim-to-real, dynamic-manipulation]
    affiliation: "AUTOLAB, UC Berkeley (at time of paper)"
  - slug: yilun-du
    kind: researcher
  ...
  - slug: zipeng-fu
    kind: researcher
    affiliation: "Carnegie Mellon University (at time of this work); later Stanford University"
  - slug: zixing-wang
